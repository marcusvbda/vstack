...
Route::group(['prefix' => "admin"], function () {
    Route::group(['middleware' => ['web', 'auth']], function () {
        ...
        Route::get('{resource}/tags/options', '\marcusvbda\vstack\Controllers\ResourceController@tagOptions')->name("resource.optionTags");
        Route::get('{resource}/{code}/tags', '\marcusvbda\vstack\Controllers\ResourceController@getTags')->middleware(['hashids:code'])->name("resource.getTags");
        Route::delete('{resource}/{code}/tags/destroy/{id}', '\marcusvbda\vstack\Controllers\ResourceController@destroyTag')->middleware(['hashids:code'])->name("resource.deleteTag");
        Route::post('{resource}/{code}/tags/add', '\marcusvbda\vstack\Controllers\ResourceController@addTag')->middleware(['hashids:code'])->name("resource.addTag");
