<template>
    <div id="save-resource-filter-btn">
        ...
        <el-button class="report-card-option new" plain type="success" small v-if="can_create" @click="create" v-loading="loading">
...
export default {
    ...
    computed: {
        ...
        has_filter() {
            return this.$root.$refs.tags_filter.selected_filters?.length > 0 ?? false
        },
    },
    methods: {
        isCurrentReport(x) {
