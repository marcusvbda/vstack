        ...
        <div class="col-12 d-flex flex-row flex-wrap align-items-center" v-if="!loading">
            ...
            <el-dialog
                ...
                <span slot="footer" class="dialog-footer" v-if="canSave">
                    ...
                    <el-button type="primary" @click="addTag">Adicionar</el-button>
                </span>
            </el-dialog>
        </div>
    </transition>
...
<script>
    export default {
        ...
        methods : {
            ...
            getTags() {
                this.attempts ++
                this.$http.get(`/admin/${this.resource}/${this.resource_code}/tags`).then(resp => {
                    resp = resp.data
                    this.tags = resp
                    this.loading = false
                }).catch(er => {
            ...
            getOptions() {
                ...
                this.$http.get(`/admin/${this.resource}/tags/options`).then(resp => {
                    resp = resp.data
                    this.options = resp
            ...
            addTag() {
                this.$http.post(`/admin/${this.resource}/${this.resource_code}/tags/add`,{
                    name : this.newTag
                }).then(resp => {
                    resp = resp.data
                    this.tags.push(resp)
