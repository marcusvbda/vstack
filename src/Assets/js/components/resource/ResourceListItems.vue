<template>
    <div class="row list-items" id="resource-list-items">
        <template v-if="loading">
            <div class="col-md-2 col-sm-12" :style="{ marginTop: 26, marginBottom: 18 }">
                <div class="shimmer" :style="{ height: 75, width: '100%' }" />
            </div>
            <div class="col-md-3 col-sm-12" :style="{ marginTop: 26, marginBottom: 18 }">
                <div class="shimmer" :style="{ height: 75, width: '100%' }" />
            </div>
        </template>
        <div
        ...
        >
            ...
            <div class="list-item--content" v-else>
                ...
                <div class="list-item--value text-muted" v-html="list_item.value" />
            </div>
        </div>
    </div>
</template>
...
export default {
    ...
    methods: {
        getValues() {
            this.$http.post(`/admin/get-list-cards`, { ...this.request_data, resource_id: this.resource_id }).then(({ data }) => {
