<template>
    <div
        :class="`row crud-type-${crud_type.template} view-only`"
        id="crud-view"
    >
        <div class="col-12">
            <div class="needs-validation m-0">
                        ...
                        <div class="col-12">
                            <template v-for="(card, i) in data.fields">
                                <v-runtime-template
                                    :key="i"
                                    :template="card.view"
                                    :id="`resource-view-card-${card.label}`"
                                />
                            </template>
                        </div>
                    </div>
                ...
                <template v-else>
                            ...
                            <div class="col-12 col-lg-3 fields-tab">
                                ...
                                >
                                    <div class="col-12">
                                        <div class="card">
                                            <div
                                                class="card-body d-none d-md-block d-lg-block"
                                                v-if="showPills"
                                            >
                                                <div
                                                    class="row"
                                                    v-if="!right_card_content"
                                                >
                                                    <div class="col-12">
                                                        <ul
                                                            class="flex flex-col mb-0 pl-3"
                                                            id="resource-section-list"
                                                        >
                                                            <li
                                                                v-for="(
                                                                    card, i
                                            ...
                                            <div
                                                class="card-footer flex-wrap flex justify-end p-2 align-center"
                                            >
                                                <el-button-group>
                                                    <el-button
                                                        v-if="first_btn"
                    ...
                    <template v-if="crud_type.template == 'wizard'">
                        <div class="row">
                            <div class="col-12 col-lg-9 flex flex-col">
                                <div :class="`flex ${wizardContentClass}`">
                                    <el-steps
                                        :active="wizard_step"
                                    ...
                                    >
                                        <template
                                            v-for="(step, i) in data.fields"
                                        >
                                            <el-step
                                                :key="`step_wizard_${i}`"
                                                :class="`resource-step ${getResourceStepStatus(
                                                    i
                                                )}`"
                                            >
                                                <div
                                    ...
                                    <div
                                        :class="`flex-grow-1 ${wizardCrudClass}`"
                                    >
                                        <transition
                                            :name="wizardTransitionName"
                                        >
                                            <v-runtime-template
                                                :template="
                                                    data.fields[wizard_step]
                                                        .view
                                                "
                            ...
                            <div class="col-12 col-lg-3 fields-tab">
                                ...
                                >
                                    <div class="col-12">
                                        <div class="card">
                                            <div
                                                class="card-body d-none d-md-block d-lg-block pb-0"
                                                v-if="showPills"
                                            >
                                                <div
                                                    class="row"
...
export default {
    ...
    computed: {
        ...
        wizardDirection() {
            ...
            return ['left', 'right'].includes(this.crud_type.position) &&
                !this.isSimple
                ? 'vertical'
                : 'horizontal';
        },
        ...
        wizardContentClass() {
            ...
            if (this.wizardDirection == 'vertical') {
                return `flex-col flex-lg-row ${
                    justifyClasses[this.wizardStepSide]
                }`;
            }
            ...
            if (this.crud_type.template == 'wizard') {
                this.$waitForEls('.resource-step').then((elements) => {
                    elements.forEach((item, index) => {
                        ['.el-step__head', '.el-step__main'].forEach(
                            (child) => {
        ...
        initFields() {
            ...
            for (let i in fields) {
                if (fields[i].options) {
                    ...
                    if (field_name) {
                        this.$set(
                            fields[i].options.type == 'resource-field'
                                ? this.resourceData
                                : this.form,
                            field_name,
                            field_value
        ...
        submit(clicked_btn = 'save_and_back') {
            const actions = {
                edit: () => {
                    ...
                    window.location.href = `${this.redirect}/edit`;
                },
                back: () => {
                    this.$loading({ text: 'Aguarde ...' });
                    window.location.href = this.redirect.replace(
                        `/${this.code}`,
                        ''
                    );
                },
