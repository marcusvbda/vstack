<template>
    <div :class="custom_class">
        <div :class="class_header">
            ...
            <div :class="class_filter_section">
                <el-input
                    ...
                    :class="class_filter_input"
                    v-model="filter"
                    @keyup.native="changeFilter"
        ...
        <div
            :class="class_pagination_section"
            v-if="!loading && total_items > per_page"
        >
            <el-pagination
                background
...
export default {
    props: {
        ...
        class_filter_section: {
            default: 'col-12 col-md-4 ml-auto flex align-end',
            type: String,
        },
        class_no_result_slot: {
            default: 'flex align-center justify-center my-5 py-5 col-12',
            type: String,
        },
        class_header_slot: {
        ...
        class_header: {
            default: 'row pagination-component-header flex ',
            type: String,
        },
        class_content: {
        ...
        class_pagination_section: {
            default: 'w-full flex justify-end mb-2 mt-4',
            type: String,
        },
        class_filter_input: {
            default: '',
    ...
    methods: {
        ...
        getItems() {
            ...
            this.$http
                .get(this.fetch_route, { params: payload })
                .then(({ data }) => {
