            ...
            <div class="d-flex flex-column row align-items-center justify-items-center">
                <div class="col-md-6 col-sm-12 text-center">
                    <h4 class="text-center mt-5">
                        ...
                        <small style="font-size: 15px;" v-html="rendered_data.nothing_stored_subtext"></small>
                    </h4>
                    <template v-if="rendered_data.can_create">
                        <button
                            type="button"
...
export default {
    ...
    methods: {
        ...
        loadView() {
            ...
            this.$http
                .post(this.resourceRoute, params)
                .then(res => {
        ...
        cleanForm() {
            for (let i in this.rendered_data.crud_fields) {
                ...
                this.$set(
                    this.rendered_data.crud_fields[i].options.type == "resource-field" ? this.resourceData : this.form,
                    field_name,
                    field_value
                );
            }
